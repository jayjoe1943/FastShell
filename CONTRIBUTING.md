# 参与 FastShell / Contributing to FastShell
...
FastShell 目前是一个**个人实验性项目**。它的设计、取舍和代码风格都由我一个人把控，目的是保持产品方向的一致性，做一个**轻量、专注的 FinalShell 风格 SSH 客户端**——不做成大而全的工具。
...
- 🐛 **报告 Bug**：在 [Issues](https://github.com/jeff141/FastShell/issues) 里描述复现步骤、系统环境和期望行为。
...
Thanks for your interest in FastShell! 🙏

FastShell is currently a **personal, experimental project**. Its design,
...
- 🐛 **Report bugs**: open an [Issue](https://github.com/jeff141/FastShell/issues)
