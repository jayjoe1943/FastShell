fn main() {
    ...
    // Source language is Chinese (the msgids); `lang/<lc>/LC_MESSAGES/FastShell.po`
    ...
    #[cfg(windows)]
    {
        println!("cargo:rerun-if-changed=assets/FastShell.ico");
        let mut res = winresource::WindowsResource::new();
        res.set_icon("assets/FastShell.ico");
